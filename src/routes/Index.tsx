...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Final CTA */}
      <section id="final-cta" className="py-16 lg:py-24 bg-gradient-to-br from-primary/8 to-accent-lavender/10 text-center">
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          ...
          <Button onClick={() => router.push("/onboarding")} size="lg" className="rounded-full px-10 text-base">
            Start Creating
          </Button>
        </div>
      </section>
