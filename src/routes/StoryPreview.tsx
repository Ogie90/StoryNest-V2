    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="sticky top-0 z-40 bg-background/80 backdrop-blur-md border-b border-border">
        <div className="max-w-2xl mx-auto px-5 h-12 flex items-center justify-between">
          <Link href="/library" className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground transition-colors">
      ...
      <div className="max-w-2xl mx-auto px-5 mt-6 space-y-5">
        ...
        <StoryLockCard
          ...
          onUnlock={() => router.push(`/upgrade${storyParam}`)}
        />
        ...
        >
          <Button variant="outline" className="flex-1 gap-2 rounded-full" onClick={() => router.push(`/edit${storyParam}`)}>
            <Pencil size={14} /> Edit Story
          </Button>
          <Button className="flex-1 gap-2 rounded-full" onClick={() => router.push(`/upgrade${storyParam}`)}>
