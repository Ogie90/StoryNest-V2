    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="py-8 px-5">
        <div className="max-w-2xl mx-auto space-y-8">
          <Button variant="ghost" size="sm" className="gap-1 text-muted-foreground" onClick={() => router.push(`/preview${storyParam}`)}>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">Edit Your Story</h1>
              <p className="text-sm text-muted-foreground">
                For {profile.name} · <span className="capitalize">{tone}</span> tone
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <Button variant="outline" className="flex-1" onClick={() => router.push(`/preview${storyParam}`)}>Cancel</Button>
          </div>
        </div>
      </div>
    </div>
